...
var J3 = Object.defineProperties;
...
var g2 = (h, i, n) => i in h ? V3(h, i, { enumerable: true, configurable: true, writable: true, value: n }) : h[i] = n;
var R = (h, i) => {
  for (var n in i || (i = {})) Y2.call(i, n) && g2(h, n, i[n]);
  if (j1) for (var n of j1(i)) Z2.call(i, n) && g2(h, n, i[n]);
  return h;
};
var j = (h, i) => J3(h, q3(i));
var Q2 = (h, i) => {
  var n = {};
  for (var s in h) Y2.call(h, s) && i.indexOf(s) < 0 && (n[s] = h[s]);
  if (h != null && j1) for (var s of j1(h)) i.indexOf(s) < 0 && Z2.call(h, s) && (n[s] = h[s]);
  return n;
};
var m = (h, i, n) => g2(h, typeof i != "symbol" ? i + "" : i, n);
var g = (h, i, n) => new Promise((s, l) => {
  var _ = (b) => {
    try {
      C(n.next(b));
    } catch (S) {
  ...
  }, C = (b) => b.done ? s(b.value) : Promise.resolve(b.value).then(_, L);
  C((n = n.apply(h, i)).next());
});
var X3 = class {
...
var K3 = class {
  constructor() {
    m(this, "_strategy"), this._strategy = typeof requestAnimationFrame == "function" ? new X3() : new G3();
  }
  requestAnimationFrame(h) {
...
var Y3 = ["v", "ip", "op", "layers", "fr", "w", "h"];
var t3 = "0.40.1";
var e3 = "@lottiefiles/dotlottie-web";
var Z3 = 0.75;
var Q3 = (() => {
  var h, i = typeof document < "u" ? (h = document.currentScript) == null ? void 0 : h.src : void 0;
  return function(n = {}) {
    var s, l = n, _, L, C = new Promise((t, e) => {
      _ = t, L = e;
    ...
    function F1(t) {
      var e;
      throw (e = l.onAbort) == null || e.call(l, t), t = "Aborted(" + t + ")", z(t), v1 = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), L(t), t;
    }
    var w2 = (t) => t.startsWith("data:application/octet-stream;base64,"), k1;
    function L2(t) {
      if (t == k1 && J) return new Uint8Array(J);
      throw "both async and sync fetching of the wasm failed";
    }
    function o3(t) {
      return J ? Promise.resolve().then(() => L2(t)) : i1(t).then((e) => new Uint8Array(e), () => L2(t));
    }
    function C2(t, e, r) {
      return o3(t).then((a) => WebAssembly.instantiate(a, e)).then(r, (a) => {
        z(`failed to asynchronously prepare wasm: ${a}`), F1(a);
      });
    }
    function s3(t, e) {
      var r = k1;
      return J || typeof WebAssembly.instantiateStreaming != "function" || w2(r) || typeof fetch != "function" ? C2(r, t, e) : fetch(r, { credentials: "same-origin" }).then((a) => WebAssembly.instantiateStreaming(a, t).then(e, function(o) {
        return z(`wasm streaming compile failed: ${o}`), z("falling back to ArrayBuffer instantiation"), C2(r, t, e);
      }));
    }
    class M2 {
      constructor(e) {
    ...
    }, X1 = l.noExitRuntime || true, b2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, A1 = (t = 0, e = NaN) => {
      var r = A, a = t + e;
      for (e = t; r[e] && !(e >= a); ) ++e;
      if (16 < e - t && r.buffer && b2) return b2.decode(r.subarray(t, e));
      for (a = ""; t < e; ) {
        var o = r[t++];
        if (o & 128) {
          var d = r[t++] & 63;
          if ((o & 224) == 192) a += String.fromCharCode((o & 31) << 6 | d);
          else {
            var c = r[t++] & 63;
            o = (o & 240) == 224 ? (o & 15) << 12 | d << 6 | c : (o & 7) << 18 | d << 12 | c << 6 | r[t++] & 63, 65536 > o ? a += String.fromCharCode(o) : (o -= 65536, a += String.fromCharCode(55296 | o >> 10, 56320 | o & 1023));
          }
    ...
    var m1 = {}, u1 = {}, T1 = {}, C1, h1 = (t, e, r) => {
      function a(u) {
        if (u = r(u), u.length !== t.length) throw new C1("Mismatched type converter count");
        for (var f = 0; f < t.length; ++f) X(t[f], u[f]);
      }
      t.forEach((u) => T1[u] = e);
      var o = Array(e.length), d = [], c = 0;
      e.forEach((u, f) => {
        u1.hasOwnProperty(u) ? o[f] = u1[u] : (d.push(u), m1.hasOwnProperty(u) || (m1[u] = []), m1[u].push(() => {
          o[f] = u1[u], ++c, c === d.length && a(o);
        }));
      }), d.length === 0 && a(o);
    }, E2, T = (t) => {
      for (var e = ""; A[t]; ) e += E2[A[t++]];
      return e;
    }, y;
    function h3(t, e, r = {}) {
      var a = e.name;
    ...
    }, P2 = (t, e, r) => e === r ? t : r.za === void 0 ? null : (t = P2(t, e, r.za), t === null ? null : r.Ta(t)), D2 = {}, d3 = {}, u3 = (t, e) => {
    ...
    var b1 = (t, e) => Object.defineProperty(e, "name", { value: t }), F2 = (t, e, r) => {
      if (t[e].xa === void 0) {
        var a = t[e];
        t[e] = function(...o) {
      ...
      if (l.hasOwnProperty(t)) {
        ...
        if (F2(l, t, t), l[t].xa.hasOwnProperty(r)) throw new y(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
        l[t].xa[r] = e;
      } else l[t] = e, l[t].Ga = r;
    }, c3 = (t) => {
    ...
    function f3(t, e, r, a, o, d, c, u) {
      this.name = t, this.constructor = e, this.Fa = r, this.Da = a, this.za = o, this.Va = d, this.Ja = c, this.Ta = u, this.bb = [];
    }
    var Q1 = (t, e, r) => {
      for (; e !== r; ) {
    ...
    function I1(t, e, r, a, o, d, c, u, f, v, p) {
      this.name = t, this.ua = e, this.Ma = r, this.Ka = a, this.La = o, this.ab = d, this.hb = c, this.Ra = u, this.Na = f, this.cb = v, this.Da = p, o || e.za !== void 0 ? this.toWireType = _3 : (this.toWireType = a ? v3 : p3, this.Ca = null);
    }
    var k2 = (t, e, r) => {
      if (!l.hasOwnProperty(t)) throw new C1("Replacing nonexistent public symbol");
      l[t].xa !== void 0 && r !== void 0 ? l[t].xa[r] = e : (l[t] = e, l[t].Ga = r);
    }, V, m3 = (t, e, r = []) => (t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, l["dynCall_" + t])(e, ...r)) : e = V.get(e)(...r), e), g3 = (t, e) => (...r) => m3(t, e, r), U = (t, e) => {
      t = T(t);
      var r = t.includes("j") ? g3(t, e) : V.get(e);
      ...
      function r(d) {
        o[d] || u1[d] || (T1[d] ? T1[d].forEach(r) : (a.push(d), o[d] = true));
      }
      var a = [], o = {};
      throw e.forEach(r), new A2(`${t}: ` + a.map(x2).join([", "]));
    }, t2 = (t, e) => {
    ...
    function e2(t, e, r, a, o) {
      var d = e.length;
      if (2 > d) throw new y("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var c = e[1] !== null && r !== null, u = y3(e), f = e[0].name !== "void", v = d - 2, p = Array(v), w = [], M = [];
    ...
    var T2 = (t) => {
    ...
    }, R2 = { name: "emscripten::val", fromWireType: (t) => {
      var e = r2(t);
      return n2(t), e;
    }, toWireType: (t, e) => $1(e), Ba: 8, readValueFromPointer: L1, Ca: null }, w3 = (t, e, r) => {
      switch (e) {
        case 1:
          return r ? function(a) {
      ...
      var r = u1[t];
      if (r === void 0) throw t = `${e} has unknown type ${x2(t)}`, new y(t);
      return r;
    }, o2 = (t) => {
    ...
    }, M3 = Object.assign({ optional: true }, R2), O2 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, b3 = (t, e) => {
      for (var r = t >> 1, a = r + e / 2; !(r >= a) && r1[r]; ) ++r;
      if (r <<= 1, 32 < r - t && O2) return O2.decode(A.subarray(t, r));
      for (r = "", a = 0; !(a >= e / 2); ++a) {
        var o = s1[t + 2 * a >> 1];
        if (o == 0) break;
      ...
      return r;
    }, A3 = Reflect.construct, E1 = {}, W2 = (t) => {
      if (!(t instanceof M2 || t == "unwind")) throw t;
    }, $2 = (t) => {
      var e;
      throw _1 = t, X1 || 0 < s2 || ((e = l.onExit) == null || e.call(l, t), v1 = true), new M2(t);
    }, x3 = (t) => {
      if (!v1) try {
        if (t(), !(X1 || 0 < s2)) try {
          _1 = t = _1, $2(t);
      ...
      if (!d2) {
        ...
        for (e in h2) h2[e] === void 0 ? delete t[e] : t[e] = h2[e];
        var r = [];
    ...
    for (var j2 = Array(256), z1 = 0; 256 > z1; ++z1) j2[z1] = String.fromCharCode(z1);
    E2 = j2, y = l.BindingError = class extends Error {
      constructor(t) {
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var R3 = { c: (t, e, r, a) => F1(`Assertion failed: ${t ? A1(t) : ""}, at: ` + [e ? e ? A1(e) : "" : "unknown filename", r, a ? a ? A1(a) : "" : "unknown function"]), m: (t, e, r) => {
      var a = new l3(t);
      throw I[a.va + 16 >> 2] = 0, I[a.va + 4 >> 2] = e, I[a.va + 8 >> 2] = r, I2 = t, I2;
    }, M: () => {
    }, J: () => {
    }, K: () => {
    }, O: function() {
      ...
      var e = x1[t];
      delete x1[t];
      var r = e.Na, a = e.Da, o = e.Qa, d = o.map((c) => c.Za).concat(o.map((c) => c.fb));
      h1([t], d, (c) => {
        var u = {};
    ...
    }, r: (t, e, r, a, o, d, c, u, f, v, p, w, M) => {
      p = T(p), d = U(o, d), u && (u = U(c, u)), v && (v = U(f, v)), M = U(w, M);
      var B = c3(p);
      Z1(B, function() {
        ...
        P = b1(p, function(...c2) {
          ...
          var V2 = H.Ea[c2.length];
          if (V2 === void 0) throw new y(`Tried to invoke ctor of ${p} with invalid number of parameters (${c2.length}) - expected (${Object.keys(H.Ea).toString()}) parameters instead!`);
          return V2.apply(this, c2);
        });
        var S1 = Object.create(G, { constructor: { value: P } });
        P.prototype = S1;
        var H = new f3(p, P, S1, M, k, d, u, v);
        if (H.za) {
          var P1;
          (P1 = H.za).Oa != null || (P1.Oa = []), H.za.Oa.push(H);
        }
        return k = new I1(p, H, true, false, false), P1 = new I1(p + "*", H, false, false, false), G = new I1(p + " const*", H, false, true, false), D2[t] = { pointerType: P1, Sa: G }, k2(B, P), [k, P1, G];
      });
    }, q: (t, e, r, a, o, d) => {
      var c = t2(e, r);
      o = U(a, o), h1([], [t], (u) => {
        ...
        }, h1([], c, (v) => (v.splice(1, 0, null), u.ua.Ea[e - 1] = e2(f, v, null, o, d), [])), [];
      });
    }, f: (t, e, r, a, o, d, c, u) => {
      var f = t2(r, a);
      e = T(e), e = T2(e), d = U(o, d), h1([], [t], (v) => {
        function p() {
        ...
        var M = v.ua.Fa, B = M[e];
        return B === void 0 || B.xa === void 0 && B.className !== v.name && B.Ga === r - 2 ? (p.Ga = r - 2, p.className = v.name, M[e] = p) : (F2(M, e, w), M[e].xa[r - 2] = p), h1([], f, (P) => (P = e2(w, P, v, d, c), M[e].xa === void 0 ? (P.Ga = r - 2, M[e] = P) : M[e].xa[r - 2] = P, [])), [];
      });
    }, U: (t) => X(t, R2), x: (t, e, r, a) => {
      function o() {
      }
      e = T(e), o.values = {}, X(t, { name: e, constructor: o, fromWireType: function(d) {
        return this.constructor.values[d];
      }, toWireType: (d, c) => c.value, Ba: 8, readValueFromPointer: w3(e, r, a), Ca: null }), Z1(e, o);
    }, k: (t, e, r) => {
      var a = a2(t, "enum");
      e = T(e), t = a.constructor, a = Object.create(a.constructor.prototype, { value: { value: r }, constructor: { value: b1(`${a.name}_${e}`, function() {
      }) } }), t.values[r] = a, t[e] = a;
    }, z: (t, e, r) => {
      e = T(e), X(t, { name: e, fromWireType: (a) => a, toWireType: (a, o) => o, Ba: 8, readValueFromPointer: L3(e, r), Ca: null });
    }, u: (t, e, r, a, o, d) => {
      var c = t2(e, r);
      t = T(t), t = T2(t), o = U(a, o), Z1(t, function() {
        W1(`Cannot call ${t} due to unbound types`, c);
      }, e - 1), h1([], c, (u) => (k2(t, e2(t, [u[0], null].concat(u.slice(1)), null, o, d), e - 1), []));
    }, l: (t, e, r, a, o) => {
      ...
      X(t, { name: e, fromWireType: o, toWireType: c, Ba: 8, readValueFromPointer: C3(e, r, a !== 0), Ca: null });
    }, h: (t, e, r) => {
      function a(d) {
        return new o(q.buffer, I[d + 4 >> 2], I[d >> 2]);
      }
      ...
      X(t, M3);
    }, $: (t, e, r, a, o, d, c, u, f, v, p, w) => {
      r = T(r), d = U(o, d), u = U(c, u), v = U(f, v), w = U(p, w), h1([t], [e], (M) => (M = M[0], [new I1(r, M.ua, false, false, true, M, a, d, u, v, w)]));
    }, A: (t, e) => {
      e = T(e);
      var r = e === "std::string";
      X(t, { name: e, fromWireType: function(a) {
        var o = I[a >> 2], d = a + 4;
        if (r) for (var c = d, u = 0; u <= o; ++u) {
          var f = d + u;
          if (u == o || A[f] == 0) {
          ...
          for (v = Array(o), u = 0; u < o; ++u) v[u] = String.fromCharCode(A[d + u]);
          v = v.join("");
        }
        return o1(a), v;
      }, toWireType: function(a, o) {
        o instanceof ArrayBuffer && (o = new Uint8Array(o));
        var d, c = typeof o == "string";
        ...
        if (r && c) for (var u = d = 0; u < o.length; ++u) {
          var f = o.charCodeAt(u);
          127 >= f ? d++ : 2047 >= f ? d += 2 : 55296 <= f && 57343 >= f ? (d += 4, ++u) : d += 3;
        }
        else d = o.length;
        if (u = u2(4 + d + 1), f = u + 4, I[u >> 2] = d, r && c) w1(o, f, d + 1);
        else if (c) for (c = 0; c < d; ++c) {
          var v = o.charCodeAt(c);
          if (255 < v) throw o1(f), new y("String has UTF-16 code units that do not fit in 8 bits");
          A[f + c] = v;
        }
        else for (c = 0; c < d; ++c) A[f + c] = o[c];
        return a !== null && a.push(o1, u), u;
      }, Ba: 8, readValueFromPointer: L1, Ca(a) {
        o1(a);
      } });
    }, s: (t, e, r) => {
      if (r = T(r), e === 2) var a = b3, o = I3, d = E3, c = (u) => r1[u >> 1];
      else e === 4 && (a = S3, o = P3, d = D3, c = (u) => I[u >> 2]);
      X(t, { name: r, fromWireType: (u) => {
        ...
        var v = d(f), p = u2(4 + v + e);
        return I[p >> 2] = v / e, o(f, p + 4, v + e), u !== null && u.push(o1, p), p;
      }, Ba: 8, readValueFromPointer: L1, Ca(u) {
        o1(u);
      } });
    }, w: (t, e, r, a, o, d) => {
      x1[t] = { name: T(e), Na: U(r, a), Da: U(o, d), Qa: [] };
    }, j: (t, e, r, a, o, d, c, u, f, v) => {
      x1[t].Qa.push({ Ua: T(e), Za: r, Xa: U(a, o), Ya: d, fb: c, eb: U(u, f), gb: v });
    }, W: (t, e) => {
      ...
      var a = k3(t, e), o = a.shift();
      t--;
      var d = Array(t);
      return e = `methodCaller<(${a.map((c) => c.name).join(", ")}) => ${o.name}>`, F3(b1(e, (c, u, f, v) => {
        for (var p = 0, w = 0; w < t; ++w) d[w] = a[w].readValueFromPointer(v + p), p += a[w].Ba;
        return u = r === 1 ? A3(u, d) : u.apply(c, d), c = [], u = o.toWireType(c, u), c.length && (I[f >> 2] = $1(c)), u;
      }));
    }, _: (t) => {
      9 < t && (a1[t + 1] += 1);
    }, X: (t) => {
      ...
      var r = setTimeout(() => {
        delete E1[t], x3(() => H2(t, performance.now()));
      }, e);
      return E1[t] = { id: r, jb: e }, 0;
    }, F: (t, e, r, a) => {
      var o = (/* @__PURE__ */ new Date()).getFullYear(), d = new Date(o, 0, 1).getTimezoneOffset();
      o = new Date(o, 6, 1).getTimezoneOffset(), I[t >> 2] = 60 * Math.max(d, o), W[e >> 2] = +(d != o), e = (c) => {
        var u = Math.abs(c);
        return `UTC${0 <= c ? "-" : "+"}${String(Math.floor(u / 60)).padStart(2, "0")}${String(u % 60).padStart(2, "0")}`;
      }, t = e(d), e = e(o), o < d ? (w1(t, r, 17), w1(e, a, 17)) : (w1(t, a, 17), w1(e, r, 17));
      ...
      var r = 0;
      return z2().forEach((a, o) => {
        var d = e + r;
        for (o = I[t + 4 * o >> 2] = d, d = 0; d < a.length; ++d) q[o++] = a.charCodeAt(d);
        q[o] = 0, r += a.length + 1;
      }), 0;
    }, T: (t, e) => {
      var r = z2();
    ...
    }, P: () => 52, N: () => 52, i: U3, d: z3, e: $3, p: j3, y: N3, b: W3, a: O3, g: H3, n: B3, R: $2, I: (t, e) => (U2(A.subarray(t, t + e)), 0) }, F = function() {
      var t;
      function e(a) {
        var o;
        return F = a.exports, n1 = F.ba, p1(), V = F.fa, d1.unshift(F.ca), N--, (o = l.monitorRunDependencies) == null || o.call(l, N), N == 0 && y1 && (a = y1, y1 = null, a()), F;
      }
    ...
    function j3(t, e, r, a, o, d) {
      var c = Q();
      try {
        return V.get(t)(e, r, a, o, d);
      } catch (u) {
        if (Z(c), u !== u + 0) throw u;
        Y(1, 0);
      }
    }
    function B3(t, e, r, a, o) {
      var d = Q();
      try {
        V.get(t)(e, r, a, o);
      } catch (c) {
        if (Z(d), c !== c + 0) throw c;
        Y(1, 0);
      }
    }
    function H3(t, e, r, a) {
    ...
    function N2() {
      function t() {
        ...
        if (!U1 && (U1 = true, l.calledRun = true, !v1)) {
          if (q1(d1), _(l), (e = l.onRuntimeInitialized) == null || e.call(l), l.postRun) for (typeof l.postRun == "function" && (l.postRun = [l.postRun]); l.postRun.length; ) {
...
var B1 = class {
  ...
  static _tryLoad(h) {
    return g(this, null, function* () {
      return yield t0({ locateFile: () => h });
    });
  }
  static _loadWithBackup() {
    return g(this, null, function* () {
      return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch((h) => g(this, null, function* () {
        let i = `https://unpkg.com/${e3}@${t3}/dist/dotlottie-player.wasm`;
...
m(B1, "_ModulePromise", null), m(B1, "_wasmURL", `https://cdn.jsdelivr.net/npm/${e3}@${t3}/dist/dotlottie-player.wasm`);
var i3 = class {
  constructor() {
  ...
  dispatch(h) {
    let i = this._eventListeners.get(h.type);
    i == null ? void 0 : i.forEach((n) => n(h));
  }
...
var t1 = class {
  ...
  static observe(h, i) {
    var n;
    this._initializeObserver(), !this._observedCanvases.has(h) && (this._observedCanvases.set(h, i), (n = this._observer) == null || n.observe(h));
  }
  static unobserve(h) {
    var i, n;
    (i = this._observer) == null || i.unobserve(h), this._observedCanvases.delete(h), this._observedCanvases.size === 0 && ((n = this._observer) == null || n.disconnect(), this._observer = null);
  }
};
...
var e1 = class {
  static _initializeObserver() {
    ...
    let h = (i) => {
      i.forEach((n) => {
        ...
        this._observedCanvases.set(n.target, [l, L]);
      });
    };
  ...
  static observe(h, i) {
    var n;
    this._initializeObserver(), !this._observedCanvases.has(h) && (this._observedCanvases.set(h, [i, 0]), (n = this._observer) == null || n.observe(h));
  }
  static unobserve(h) {
    var i, n;
    (i = this._observer) == null || i.unobserve(h), this._observedCanvases.delete(h), this._observedCanvases.size === 0 && ((n = this._observer) == null || n.disconnect(), this._observer = null);
...
function J2(h) {
  ...
  let i = new Uint8Array(h.slice(0, f2.byteLength));
  for (let n = 0; n < f2.length; n += 1) if (f2[n] !== i[n]) return false;
  return true;
}
function q2(h) {
  return Y3.every((i) => Object.prototype.hasOwnProperty.call(h, i));
}
function X2(h) {
  if (typeof h == "string") try {
    return q2(JSON.parse(h));
  } catch {
    return false;
  }
  else return q2(h);
...
function f1() {
  return 1 + (($ ? window.devicePixelRatio : 1) - 1) * Z3;
}
function n3(h) {
...
var v2 = (h, i) => h === "reverse" ? i.Mode.Reverse : h === "bounce" ? i.Mode.Bounce : h === "reverse-bounce" ? i.Mode.ReverseBounce : i.Mode.Forward;
var _2 = (h, i) => h === "contain" ? i.Fit.Contain : h === "cover" ? i.Fit.Cover : h === "fill" ? i.Fit.Fill : h === "fit-height" ? i.Fit.FitHeight : h === "fit-width" ? i.Fit.FitWidth : i.Fit.None;
var p2 = (h, i) => {
...
var r3 = class E {
  constructor(i) {
    ...
    var n, s, l;
    this._canvas = i.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new i3(), this._frameManager = new K3(), this._renderConfig = j(R({}, i.renderConfig), { devicePixelRatio: ((n = i.renderConfig) == null ? void 0 : n.devicePixelRatio) || f1(), freezeOnOffscreen: (l = (s = i.renderConfig) == null ? void 0 : s.freezeOnOffscreen) != null ? l : true }), B1.load().then((_) => {
      var L, C, b, S, x, i1, z, J;
      E._wasmModule = _, this._dotLottieCore = new _.DotLottiePlayer({ themeId: (L = i.themeId) != null ? L : "", autoplay: (C = i.autoplay) != null ? C : false, backgroundColor: 0, loopAnimation: (b = i.loop) != null ? b : false, mode: v2((S = i.mode) != null ? S : "forward", _), segment: m2((x = i.segment) != null ? x : [], _), speed: (i1 = i.speed) != null ? i1 : 1, useFrameInterpolation: (z = i.useFrameInterpolation) != null ? z : true, marker: (J = i.marker) != null ? J : "", layout: i.layout ? { align: p2(i.layout.align, _), fit: _2(i.layout.fit, _) } : _.createDefaultLayout() }), this._eventManager.dispatch({ type: "ready" }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), i.backgroundColor && this.setBackgroundColor(i.backgroundColor);
    }).catch((_) => {
  ...
  _fetchData(i) {
    return g(this, null, function* () {
      ...
      return J2(s) ? s : new TextDecoder().decode(s);
    });
  }
  _loadFromData(i) {
  ...
  load(i) {
    var n, s, l, _, L, C, b, S, x;
    this._dotLottieCore === null || E._wasmModule === null || (this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), this._dotLottieCore.setConfig({ themeId: (n = i.themeId) != null ? n : "", autoplay: (s = i.autoplay) != null ? s : false, backgroundColor: 0, loopAnimation: (l = i.loop) != null ? l : false, mode: v2((_ = i.mode) != null ? _ : "forward", E._wasmModule), segment: m2((L = i.segment) != null ? L : [], E._wasmModule), speed: (C = i.speed) != null ? C : 1, useFrameInterpolation: (b = i.useFrameInterpolation) != null ? b : true, marker: (S = i.marker) != null ? S : "", layout: i.layout ? { align: p2(i.layout.align, E._wasmModule), fit: _2(i.layout.fit, E._wasmModule) } : E._wasmModule.createDefaultLayout() }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), this.setBackgroundColor((x = i.backgroundColor) != null ? x : ""));
  }
  _render() {
  ...
  _draw() {
    ...
    let i = Math.round(this._dotLottieCore.requestFrame() * 100) / 100;
  ...
  setBackgroundColor(i) {
    this._dotLottieCore !== null && ($ && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = i : this._dotLottieCore.setConfig(j(R({}, this._dotLottieCore.config()), { backgroundColor: i0(i) })), this._backgroundColor = i);
  }
  setLoop(i) {
  ...
  setSegment(i, n) {
    this._dotLottieCore === null || E._wasmModule === null || this._dotLottieCore.setConfig(j(R({}, this._dotLottieCore.config()), { segment: m2([i, n], E._wasmModule) }));
  }
  setMode(i) {
  ...
  setRenderConfig(i) {
    let n = i, { devicePixelRatio: s, freezeOnOffscreen: l } = n, _ = Q2(n, ["devicePixelRatio", "freezeOnOffscreen"]);
  ...
  setLayout(i) {
    this._dotLottieCore === null || E._wasmModule === null || this._dotLottieCore.setConfig(j(R({}, this._dotLottieCore.config()), { layout: { align: p2(i.align, E._wasmModule), fit: _2(i.fit, E._wasmModule) } }));
  }
  setViewport(i, n, s, l) {
  ...
  _getPointerPosition(i) {
    let n = this._canvas.getBoundingClientRect(), s = this._canvas.width / n.width, l = this._canvas.height / n.height, _ = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, L = (i.clientX - n.left) * s / _, C = (i.clientY - n.top) * l / _;
    return { x: L, y: C };
  }
  _onPointerUp(i) {
  ...
  animationSize() {
    var i, n, s, l;
    let _ = (n = (i = this._dotLottieCore) == null ? void 0 : i.animationSize().get(0)) != null ? n : 0, L = (l = (s = this._dotLottieCore) == null ? void 0 : s.animationSize().get(1)) != null ? l : 0;
    return { width: _, height: L };
  }
  ...
  getLayerBoundingBox(i) {
    ...
    let l = s.get(0), _ = s.get(1), L = s.get(2), C = s.get(3);
    return { x: l, y: _, width: L, height: C };
  }
...
function G2(h, i) {
  if (h instanceof HTMLCanvasElement) {
    let { height: n, width: s } = h.getBoundingClientRect();
...
var y2 = class c1 {
  ...
  _handleWorkerEvent(i) {
    return g(this, null, function* () {
      let n = i.data;
      n.id || (n.method === "onLoad" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event), $ && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && t1.observe(this._canvas, this), this._dotLottieInstanceState.renderConfig.autoResize && e1.observe(this._canvas, this))), n.method === "onComplete" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onDestroy" && n.result.instanceId === this._id && this._eventManager.dispatch(n.result.event), n.method === "onUnfreeze" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._dotLottieInstanceState.isFrozen = false, this._eventManager.dispatch(n.result.event)), n.method === "onFrame" && n.result.instanceId === this._id && (this._dotLottieInstanceState.currentFrame = n.result.event.currentFrame, this._eventManager.dispatch(n.result.event)), n.method === "onRender" && n.result.instanceId === this._id && this._eventManager.dispatch(n.result.event), n.method === "onFreeze" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onPause" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onPlay" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onStop" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onLoadError" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)), n.method === "onReady" && n.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(n.result.event)));
    });
  }
  _create(i) {
    return g(this, null, function* () {
      ...
      let { instanceId: l } = yield this._sendMessage("create", R({ instanceId: this._id, config: j(R({}, i), { canvas: s }) }, G2(this._canvas, ((n = i.renderConfig) == null ? void 0 : n.devicePixelRatio) || f1())), [s]);
  ...
  play() {
    return g(this, null, function* () {
      this._created && (yield this._sendMessage("play", { instanceId: this._id }), yield this._updateDotLottieInstanceState(), $ && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !n3(this._canvas) && (yield this.freeze()));
    });
  }
  pause() {
    return g(this, null, function* () {
  ...
  resize() {
    return g(this, null, function* () {
      if (!this._created) return;
      let { height: i, width: n } = G2(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || f1());
  ...
  _sendMessage(i, n, s) {
    return g(this, null, function* () {
      let l = { id: `dotlottie-request-${K2()}`, method: i, params: n };
      return this._worker.postMessage(l, s || []), new Promise((_, L) => {
        let C = (b) => {
          let S = b.data;
          S.id === l.id && (this._worker.removeEventListener("message", C), S.error ? L(new Error(`Failed to execute method ${i}: ${S.error}`)) : _(S.result));
        };
  ...
  _getPointerPosition(i) {
    let n = this._canvas.getBoundingClientRect(), s = this._canvas.width / n.width, l = this._canvas.height / n.height, _ = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1, L = (i.clientX - n.left) * s / _, C = (i.clientY - n.top) * l / _;
    return { x: L, y: C };
  }
  _onPointerUp(i) {
    let { x: n, y: s } = this._getPointerPosition(i);
...
m(y2, "_workerManager", new a0()), m(y2, "_wasmUrl", "");
var N1 = y2;
var J1 = ({ animationId: h, autoplay: i, backgroundColor: n, className: s, createDotLottie: l, data: _, dotLottieRefCallback: L, layout: C, loop: b, mode: S, playOnHover: x, renderConfig: i1, segment: z, speed: J, src: n1, style: v1, themeData: _1, themeId: q, useFrameInterpolation: A, workerId: s1, ...r1 }) => {
  let [W, I] = (0, import_react.useState)(null), l1 = (0, import_react.useRef)(null), D = (0, import_react.useRef)(null), p1 = (0, import_react.useRef)(L), g1 = { speed: J, mode: S, loop: b, useFrameInterpolation: A, segment: z, backgroundColor: n, autoplay: i, themeId: q, workerId: s1, src: n1, data: _, layout: C, renderConfig: i1 }, d1 = (0, import_react.useRef)(g1);
  p1.current = L, D.current = W, d1.current = g1, (0, import_react.useEffect)(() => {
    typeof p1.current == "function" && W && p1.current(W);
  }, [W]);
  let D1 = (0, import_react.useCallback)((K) => {
    if (l1.current = K, K) {
      let N = l({ ...d1.current, canvas: K });
      I(N);
  ...
  return (0, import_react.useEffect)(() => {
    ...
    var _a;
    typeof _ != "string" && typeof _ != "object" || ((_a = D.current) == null ? void 0 : _a.load({ data: _, ...d1.current }));
  }, [_]), (0, import_react.useEffect)(() => {
    var _a;
    typeof n1 == "string" && ((_a = D.current) == null ? void 0 : _a.load({ src: n1, ...d1.current }));
  }, [n1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = D.current) == null ? void 0 : _a.setMarker(r1.marker ?? "");
  }, [r1.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = D.current) == null ? void 0 : _a.loadAnimation(h ?? "");
    ...
    var _a;
    (_a = D.current) == null ? void 0 : _a.setLayout({ align: (C == null ? void 0 : C.align) ?? [0.5, 0.5], fit: (C == null ? void 0 : C.fit) ?? "contain" });
  }, [C == null ? void 0 : C.align[0], C == null ? void 0 : C.align[1], C == null ? void 0 : C.fit]), (0, import_jsx_runtime.jsx)("div", { className: s, ...!s && { style: { width: "100%", height: "100%", lineHeight: 0, ...v1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: D1, style: { width: "100%", height: "100%" }, ...r1 }) });
};
var l0 = (h) => new H1(h);
var D0 = (h) => (0, import_jsx_runtime.jsx)(J1, { ...h, createDotLottie: l0 });
var d0 = (h) => new N1(h);
var T0 = (h) => (0, import_jsx_runtime.jsx)(J1, { ...h, createDotLottie: d0 });
var $0 = (h) => {
  N1.setWasmUrl(h), H1.setWasmUrl(h);
};
export {
  D0 as DotLottieReact,
